...
bildirimsel bir manifestte (\tcode{train/datasets.yaml}) toplanmıştır; lisanslar Bölüm 5'te listelidir.
...
\tcode{pending}'tir. Bu davranış Bölüm 3.3'teki onay marjı, pozisyon-veto ve zemin koşulu zırhlarının
ölçülen sonucudur.
...
makro-F1'ine dahildir (Bölüm 4.3). Mutlak hız için MAE/MAPE harness'ı hazırdır; kalibrasyon ve gerçek-hız
...
ki Bölüm 4 tablolarını bu özetlerden yeniden üretir — yani rapordaki hiçbir sayı elle girilmemiştir.
...
(CER 0,0); (3) bu güvenceler somut config-driven zırhlara dayanır (Bölüm 3.3) ve gerçek videolarda
