...
\item Yapay zekâ desteği: raporun yazım/düzenlenmesinde büyük dil modelinden (büyük dil modeli) destek alınmıştır; tüm teknik içerik ve sayılar takımca üretilip depo artefaktlarından doğrulanmıştır.
\end{enumerate}
\normalsize
