...
\textbf{Takım ID:} & \underline{\hspace{5.2cm}}~{\footnotesize\itshape(sonra eklenecek)} \\[12pt]
\textbf{Başvuru ID:} & \underline{\hspace{5.2cm}}~{\footnotesize\itshape(sonra eklenecek)} \\[12pt]
\textbf{Tarih:} & \underline{\hspace{5.2cm}} \\
\end{tabular}
...
\includegraphics[width=0.45\textwidth]{fig_veri_dengesi.png}
...
\begin{figure}[H]\centering
\includegraphics[width=0.50\textwidth]{fig_split.png}
...
\begin{figure}[H]\centering
\includegraphics[width=0.60\textwidth]{fig_mimari.png}
...
Ortalama işleme hızı Apple Silicon/MPS (M4 Pro) üzerinde ölçülmüştür (Şekil~\ref{fig:fps}) ve bir
\textbf{alt-sınırdır}; sunucu dağıtımında CUDA ile belirgin biçimde daha yüksek değerler elde edilir.
\tcode{yolo26l} ortalama \textbf{5,9 FPS}, \tcode{v4-finetune} (A/B tabanı) \textbf{5,3 FPS}.
\begin{figure}[H]\centering
\includegraphics[width=0.38\textwidth]{fig_fps.png}
\caption{Ortalama işleme hızı (MPS, M4 Pro) — alt-sınır. Kaynak: \tcode{eval\_results/metrics\_report.md}.}
\label{fig:fps}
\end{figure}
...
açıkça belirtilmiş olup komite verisiyle daha da güçlendirilecektir.

% ========================== 5. KAYNAKÇA ==============================
\section{Kaynakça}
{\footnotesize Tam liste (47 kaynak), açık veri seti lisansları ve izlenebilirlik tablosu: \tcode{kaynakca.md}.\par}
\footnotesize\sloppy
